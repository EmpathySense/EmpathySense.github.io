...
class Merlin
{
    ...
    public function generate_child_style_css($slug, $parent, $author, $version)
    {
        ...
        $output = "
			...
			* Description: This is a child theme of {$parent}, generated by Crete Auto Installer.
			* Author: {$author}
			* Template: {$slug}
			* Version: {$version}
			*/\n
    ...
    public function generate_child_functions_php($slug)
    {
        ...
        $output = "
			 ...
			 * This child theme was generated by Crete Auto Installer.
			 *
     ...
     * Get the next step link.
     */
    protected function step_prev_link()
    {
        $keys = array_keys($this->steps);
        $step = array_search($this->step, $keys, true) - 1;
                        ...
                        <?php foreach ($required_plugins as $slug => $plugin) : ?>
                            <li data-slug="<?php echo esc_attr($slug); ?>">
                                ...
                                <label for="default_plugins_<?php echo esc_attr($slug); ?>">
                                    ...
                                    <span class="badge">
									<span class="hint--top"
                                          aria-label="<?php esc_html_e('Required', '@@textdomain'); ?>">
    ...
    protected function license_mayosis()
    { ?>
        <div class="merlin__content--transition">
            <?php echo wp_kses($this->svg(array('icon' => 'license')), $this->svg_allowed_html()); ?>
            ...
            <?php if (class_exists('mayosis_core')) { ?>
                ...
                <?php
                if (function_exists('mayosis_lisense_box')) {
                    mayosis_lisense_box();
                }
        ...
        <form action="" method="post">
            ...
            <footer class="merlin__content__footer <?php echo esc_attr($class); ?>">
                ...
                <a href="<?php echo esc_url($this->step_next_link()); ?>"
                   class="merlin__button merlin__button--next merlin__button--proceed merlin__button--colorchange"><?php esc_html_e('Next', '@@textdomain'); ?></a>
        ...
        <div class="merlin__content--transition">
            ...
            <a id="merlin__drawer-trigger"
               class="merlin__button merlin__button--knockout"><span><?php echo esc_html($action); ?></span><span
                        class="chevron"></span></a>
            <?php } else { ?>
                Please ensure the Crete Core plugin has been installed correctly. <a
                        href="<?php echo esc_url($this->step_prev_link()); ?>">Return to Required
                    Plugins installer</a>.
            <?php } ?>
