...
class Crete {
	...
	function __construct() {
		...
		if(CreteBase::CheckWPPlugin($licenseKey,$liceEmail,$this->licenseMessage,$this->responseObj,$templateDir."/style.css")){
	...
	function action_deactivate_license() {
		check_admin_referer( 'el-license' );
		$message="";
		if(CreteBase::RemoveLicenseKey(__FILE__,$message)){
			update_option("Crete_lic_Key","") || add_option("Crete_lic_Key","");
			update_option('_site_transient_update_themes','');
		}
    	wp_safe_redirect(admin_url( 'admin.php?page='.$this->slug));
